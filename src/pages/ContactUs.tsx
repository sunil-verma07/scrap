...
const Contactus = () => {
    document.title = 'Contact Us | Scrapbag';
    ...
    return (
        <div className="bg-white">
                        ...
                        <div className="container">
                            <div className="items-center justify-center flex flex-wrap lg:h-[500px] md:py-0 xl:gap-64">
                                <div className="heading mb-0 lg:text-left text-center">
                                    <div className="text-white text-2xl lg:text-[40px] font-bold mt-5">Contact Us</div>
                                ...
                                <div className="relative mt-5 md:mt-0" data-aos='fade-left' data-aos-duration="1000">
                                    <img className="h-[20rem]" src="/assets/images/illustration_contactUs.png" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-14 flex flex-wrap items-center justify-center lg:py-[100px] font-HindMysuru">
                <div>
                    <h4 className="sm:!leading-[65px] text-defaultLime text-center text-[40.5px] font-bold">Get in touch with us</h4>
                    <div className="relative z-10 flex flex-wrap items-center justify-center gap-[60px]">
                        <div className="text-center lg:text-left">
                            <div>
                                <div className="rounded-[32px] bg-white px-4 py-6 md:p-6" data-aos="fade-up" data-aos-duration="1000">
                                    <div className="mb-4 flex items-center gap-2 text-defaultLime">
                                        <div>
                                    ...
                                    <a
                                        href="tel:+91 8290679916"
                                        className="font-bold text-[#08111F]  hover:text-defaultLime lg:text-[14.5px]"
                                    >
                                        +91 935-197-4856
                                    </a>
                                </div>
                                ...
                                <div className="rounded-[32px] bg-white px-4 py-6 md:p-6" data-aos="fade-up" data-aos-duration="1000">
                                    ...
                                    <h5 className="font-bold text-[#08111F]  hover:text-defaultLime lg:text-[14.5px]">Bhamashah Techno hub,<br /> Jhalana,
                                        Malviya nagar, Jaipur</h5>
                                </div>
                            </div>

                            <ul className="mt-8 flex items-center justify-center gap-2 " data-aos="fade-up" data-aos-duration="500">
                                <li className="h-[40px] w-[40px] md:h-[55px] md:w-[53px]">
            ...
            <section className="flex items-center justify-center py-14 lg:py-[100px] font-HindMysuru">
                <div className="w-3/5 px-4 lg:px-0">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3559.1225809739717!2d75.81574347451897!3d26.86784626201884!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396db7b51669dee9%3A0x3708a6ae96453829!2sBhamashah%20Techno%20Hub!5e0!3m2!1sen!2sin!4v1701859360909!5m2!1sen!2sin" className="w-full h-[320px] rounded-3xl"></iframe>
                </div>
            </section>
